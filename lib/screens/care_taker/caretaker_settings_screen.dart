...
class CareTakerSettingsScreen extends StatelessWidget {
  ...
  Widget _tile(
    ...
    return ListTile(
      ...
      leading: Container(
        ...
        height: 42,
        decoration: BoxDecoration(
          gradient: useGradient ? AppColors.gradient : null,
          color: useGradient ? null : (overrideIconBg ?? AppColors.primary.withOpacity(0.12)),
          borderRadius: BorderRadius.circular(12),
          boxShadow: useGradient ? AppColors.glowShadow : [],
        ),
        child: Icon(
          icon,
          color: useGradient ? Colors.white : (overrideIconColor ?? AppColors.primary),
          size: 20,
        ),
      ),
      title: Text(
  ...
  Widget _section(BuildContext ctx, String label, List<Widget> tiles) {
    final isDark = Theme.of(ctx).brightness == Brightness.dark;
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              // EDIT BUTTON
              GestureDetector(
                onTap: () => _go(context, CareTakerProfileScreen(userId: userId)),
                child: Container(
                  width: 34,
                  height: 34,
                  decoration: BoxDecoration(
        ...
        _section(
          ...
          [
            ...
            _tile(
              ...
              onTap: () => _go(context, PaymentDetailsScreen(userId: userId)),
            ),
            _tile(
              context,
        ...
        _section(
          ...
          [
            ...
            _tile(
              ...
              onTap: () => _go(context, RatingsReviewsScreen(userId: userId)),
            ),
            _tile(
              context,
              icon: Icons.insights_rounded,
              title: "Performance Analytics",
              onTap: () => _go(context, PerformanceAnalyticsScreen(userId: userId)),
            ),
          ],
        ),
        ...
        _section(
          ...
          [
            ...
            _tile(
              ...
              title: "Live Chat",
              onTap: () => _go(context, const LiveChatScreen()),
            ),
            ...
            _tile(
              ...
              title: "Emergency SOS",
              onTap: () => _go(context, const EmergencySOSScreen()),
              useGradient: false,
              overrideIconBg: AppColors.danger.withOpacity(0.12),
              overrideIconColor: AppColors.danger,
            ),
        ...
        _section(
          ...
          [
            ...
            _tile(
              ...
              onTap: () => _go(context, const TermsConditionsScreen()),
            ),
          ],
        ),
