...
class _RadiusSettingsScreenState extends State<RadiusSettingsScreen> {
  ...
  Future<void> _save() async {
    ...
    if (radius == null || radius <= 0) {
      return _toast("Radius must be greater than 0", isError: true);
    }

    setState(() => _loading = true);
    try {
      final res = await http.post(
        Uri.parse(Api.setRadius),
      ...
      _toast("Network error. Try again.", isError: true);
    }
  ...
  // FIXED: label wrapped in Expanded so long text no longer overflows the card
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: const [
                          ...
                          SizedBox(height: 3),
                          Text(
                            "Control caretaker visibility range",
